...
public class BluetoothService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkFindme = (CheckBox)findViewById(R.id.checkFindme);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action){
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_STARTED:
                    ...
                    Toast.makeText(BluetoothService.this, "블루투스 검색 시작", Toast.LENGTH_SHORT).show();
                    break;
                //블루투스 디바이스 찾음
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                    Toast.makeText(BluetoothService.this, "블루투스 검색 종료", Toast.LENGTH_SHORT).show();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (state){
                ...
                case BluetoothAdapter.SCAN_MODE_NONE:
                    checkFindme.setChecked(false);
                    checkFindme.setEnabled(true);
                    Toast.makeText(BluetoothService.this, "검색응답 모드 종료", Toast.LENGTH_SHORT).show();
                    break;
                case BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE:
                    Toast.makeText(BluetoothService.this, "다른 블루투스 기기에서 내 휴대폰을 찾을 수 있습니다.", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
